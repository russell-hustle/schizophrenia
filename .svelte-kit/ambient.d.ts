...
declare module '$env/static/private' {
	...
	export const npm_package_devDependencies_smui_theme: string;
	export const CONDA_SHLVL: string;
	export const GOBIN: string;
	export const npm_package_scripts_lint: string;
	export const npm_package_scripts_smui_theme_dark: string;
	export const CONDA_PROMPT_MODIFIER: string;
	export const TERM_PROGRAM_VERSION: string;
	export const npm_package_dependencies_crypto: string;
	export const npm_package_devDependencies_partykit: string;
	export const TERM_SESSION_ID: string;
	export const npm_package_devDependencies__sveltejs_kit: string;
	export const npm_config_registry: string;
	export const PNPM_HOME: string;
	export const ZSH: string;
	export const npm_package_dependencies_partysocket: string;
	...
	export const npm_package_scripts_smui_theme_light: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		TMPDIR: string;
		npm_package_devDependencies_smui_theme: string;
		CONDA_SHLVL: string;
		GOBIN: string;
		npm_package_scripts_lint: string;
		npm_package_scripts_smui_theme_dark: string;
		CONDA_PROMPT_MODIFIER: string;
		TERM_PROGRAM_VERSION: string;
		npm_package_dependencies_crypto: string;
		npm_package_devDependencies_partykit: string;
		TERM_SESSION_ID: string;
		npm_package_devDependencies__sveltejs_kit: string;
		npm_config_registry: string;
		PNPM_HOME: string;
		ZSH: string;
		npm_package_dependencies_partysocket: string;
		USER: string;
		...
		TMUX_PANE: string;
		XPC_FLAGS: string;
		npm_package_scripts_smui_theme_light: string;
